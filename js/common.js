...
const FABManager = {
    ...
    resetToDefaultState: function() {
        ...
        if (suggestionsSelect) {
            suggestionsSelect.innerHTML = '<option value="">分析項目を選択してください</option>' +
                '<option value="指標のサマリを教えてください">指標のサマリ</option>' +
                '<option value="仮説とアクションを提案してください">仮説とアクション</option>' +
                '<option value="目標に対する進捗はどうですか？">目標に対する進捗</option>';
        }
    }
};
